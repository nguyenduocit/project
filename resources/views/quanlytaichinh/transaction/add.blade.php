    ...
    @section('content')
        <div class="content-wrapper">
            ...
            <section class="content-header">
              <h1>
                Add Transaction
                <small>Add to your transaction</small>
              </h1>
              <ol class="breadcrumb">
            ...
            <section class="content">
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <form role="form" action="{{ URL::route('transection.postAdd')}}" method="post" id="form-add">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('wallets_id')) has-error @endif">
                                            <select name="wallets_id" id="type"   class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="true">
                                                ...
                                                <option @if(old('wallets_id') == $val['id']) selected ="selected" @endif value="{{ $val['id']}}" >{{ $val['name']}}</option>
                                                @endforeach
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('amount')) has-error @endif">
                                            <input type="date" name="date_now" class="form-control" id="exampleInputAmount" maxlength="18" value="{{ old('date_now')}}">
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12 @if($errors->first('describe')) has-error @endif">
                                            <textarea name="describe" class="form-control" rows="10">{{ old('describe')}}</textarea>
